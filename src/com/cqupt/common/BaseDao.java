...
public class BaseDao<T extends BaseEntity> extends HibernateDaoSupport {
	 ...
	 *            查询hql
	 * @param parms
	 *            NamedParam key参数名 value参数值
	 * @return List<T> 返回类型
	 * @throws 异常说明
	 */
	@SuppressWarnings("rawtypes")
	public List findByNamedParam(String hql, Map<String, Object> parms) {
		...
		List list = getHibernateTemplate().findByNamedParam(hql, paramNames,
				values);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public PageBean findPageByQuery(final String hql,
			final Map<String, Object> parms, final PageBean pageBean) {
