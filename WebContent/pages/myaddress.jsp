...
#main-left{width:20%; height:480px; float:left; background-image: url(images/bg.png);}
#main-right{width:70%; height:480px; float:left;}
...
<form class="myinfo form-horizontal" action="user/myaddressupdate">
 <div class="form-group">
<label for="address" class="control-label">当前收货地址：</label>
<input type="hidden" name="address.addressid" value="<s:property value="address.addressid" />">
<s:property value="address.area" />
</div>
<br/>
<hr style="border-bottom:2px dashed #000000;">
<div class="form-group">
<label for="address" class="control-label">修改地址：</label>
<input type="text" class="form-control" name="address.area" value="<s:property value="address.area" />">
</div>
<input type="submit" class="btn btn-default" value="修改">
</form>

<form class="myinfo form-horizontal" action="user/myaddressaddop">
<div class="form-group">
<label for="address" class="control-label">添加地址：</label>
