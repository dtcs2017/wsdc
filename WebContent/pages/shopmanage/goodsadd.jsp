    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="shopmanage/goodsaddop" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text" name="goods.goodsname" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text" name="goods.sales" size="50" value="" type="text">
                            </td>
                        </tr>
                         <tr>
                            <th><i class="require-red">*</i>单价：</th>
                            <td>
                                <input class="common-text" name="goods.price" size="50" value="" type="text">
                            </td>
                        </tr>
                         <tr>
                            <th><i class="require-red">*</i>商品简介：</th>
                            <td>
                                <textarea name="goods.introduc" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea>
                            </td>
                        </tr>
                        <tr>
