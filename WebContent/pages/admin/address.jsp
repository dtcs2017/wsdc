    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="admin/getaddresslist" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">地址名:</th>
                            <td><input class="common-text" placeholder="关键字" name="address.area" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                       <!--  <a href="pages/admin/useradd.jsp"><i class="icon-font"></i>添加用户</a> -->
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <s:iterator value="pageBean.list">
                            ...
                            <td>
                               <!--  <a class="link-update" href='admin/userupdate?user.userid=<s:property value="userid"/>'>修改</a> -->
                                <a class="link-del" href='admin/addressdel?address.addressid=<s:property value="addressid"/>'>删除</a>
                            </td>
                        </tr>
                        </s:iterator>
                    </table>
        ...
        <s:else>
            <a href="admin/getaddresslist">首页</a>
            
            <a href='admin/getaddresslist?pageBean.currentPage=<s:property value="pageBean.currentPage - 1"/>'>上一页</a>
        </s:else>
        
        <s:if test="pageBean.currentPage != pageBean.totalPage">
            <a href='admin/getaddresslist?pageBean.currentPage=<s:property value="pageBean.currentPage + 1"/>'>下一页</a>
            
            <a href='admin/getaddresslist?pageBean.currentPage=<s:property value="pageBean.totalPage"/>'>尾页</a>
        </s:if>
