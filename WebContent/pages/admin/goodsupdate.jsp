    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/goodsupdateoperate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="goods.goodsid" value="<s:property value="goods.goodsid"/>">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="goods.category" id="catid" class="required">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <textarea name="goods.introduc" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><s:property value="goods.introduc"/></textarea>
                            </td>
                        </tr>
                        <tr>
