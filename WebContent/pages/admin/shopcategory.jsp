...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">商家类别</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="admin/getshopcategorylist" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">类别名:</th>
                            <td><input class="common-text" placeholder="关键字" name="shopcategory.category" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="pages/admin/shopcategoryadd.jsp"><i class="icon-font"></i>添加类别</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <s:iterator value="pageBean.list">
                            ...
                            <td><s:property value="shopcategoryid"/></td>
                            <td><s:property value="pid"/></td>
                            <td><s:property value="category"/></td>
                            <td>
                                <a class="link-update" href='admin/shopcategoryupdate?shopcategory.shopcategoryid=<s:property value="shopcategoryid"/>'>修改</a>
                                <a class="link-del" href='admin/shopcategorydel?shopcategory.shopcategoryid=<s:property value="shopcategoryid"/>'>删除</a>
                            </td>
                        </tr>
                        </s:iterator>
                    </table>
        ...
        <s:else>
            <a href="admin/getshopcategorylist">首页</a>
            
            <a href='admin/getshopcategorylist?pageBean.currentPage=<s:property value="pageBean.currentPage - 1"/>'>上一页</a>
        </s:else>
        
        <s:if test="pageBean.currentPage != pageBean.totalPage">
            <a href='admin/getshopcategorylist?pageBean.currentPage=<s:property value="pageBean.currentPage + 1"/>'>下一页</a>
            
            <a href='admin/getshopcategorylist?pageBean.currentPage=<s:property value="pageBean.totalPage"/>'>尾页</a>
        </s:if>
