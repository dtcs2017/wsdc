...
<div class="container clearfix">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                       <li><a href="admin/getuserlist"><i class="icon-font">&#xe008;</i>用户管理</a></li>
                        <li><a href="admin/getareacatelist"><i class="icon-font">&#xe005;</i>商家分类</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">地理类别</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="admin/getareacatelist" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">类别名:</th>
                            <td><input class="common-text" placeholder="关键字" name="areacate.area" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin/areacateadd"><i class="icon-font"></i>添加类别</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <s:iterator value="pageBean.list">
                            ...
                            <td><s:property value="areacateid"/></td>
                            <td><s:property value="pid"/></td>
                            <td><s:property value="area"/></td>
                            <td>
                                <a class="link-update" href='admin/areacateupdate?areacate.areacateid=<s:property value="areacateid"/>'>修改</a>
                                <a class="link-del" href='admin/areacatedel?areacate.areacateid=<s:property value="areacateid"/>'>删除</a>
                            </td>
                        </tr>
                        </s:iterator>
                    </table>
        ...
        <s:else>
            <a href="admin/getareacatelist">首页</a>
            
            <a href='admin/getareacatelist?pageBean.currentPage=<s:property value="pageBean.currentPage - 1"/>'>上一页</a>
        </s:else>
        
        <s:if test="pageBean.currentPage != pageBean.totalPage">
            <a href='admin/getareacatelist?pageBean.currentPage=<s:property value="pageBean.currentPage + 1"/>'>下一页</a>
            
            <a href='admin/getareacatelist?pageBean.currentPage=<s:property value="pageBean.totalPage"/>'>尾页</a>
        </s:if>
