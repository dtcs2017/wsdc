...
<html>
  ...
  <center>
    ...
    <div class="content">
    	<div class="wrapper">
    		<div class="left">
    			<p class="logo-title">欢迎管理员登录</p>
    			<img style="margin:0;padding:0;margin-top:30px;margin-left:-50px" src="resources/admin/image/rihe.png">
    		</div>
    		<div class="right">
    		<form action="adminhome/adminlogin" method="post">
    		  <div style="margin-top:100px">
    			用户姓名:<input type="text" name="adminname" placeholder="用户姓名">
    		</div>
    		
    		<div>
    			用户密码:<input type="password" name="adminpassword" class="last" placeholder="用户密码">
    		</div>
    		<hr style="border: 1px solid #E0E0E0;margin:20px"/>
    		<div style="margin-top:10px;">
    			<button type="submit">登录</button>
    			<a href="pages/shopmanage/shoplogin.jsp">商家登录</a>
    		</div>
    		</form>
    		</div>
    	</div>
