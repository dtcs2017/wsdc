...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">商家管理</a><span class="crumb-step">&gt;</span><span>新增商家</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/shopaddoperation" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th width="120"><i class="require-red">*</i>分类：</th>
                            <td>
                                <select name="shop.category" id="catid" class="required">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text" name="shop.shopname" size="50" value="" type="text">
                            </td>
                        </tr>
                         <tr>
                            <th><i class="require-red">*</i>商家地址：</th>
                            <td>
                                <input class="common-text" name="shop.address" size="50" value="" type="text">
                            </td>
                        </tr>
                         <tr>
                            <th><i class="require-red">*</i>商家电话：</th>
                            <td>
                                <input class="common-text" name="shop.tel" size="50" value="" type="text">
                            </td>
                        </tr>
                         <tr>
                            <th><i class="require-red">*</i>商家简介：</th>
                            <td>
                                <textarea name="shop.introduc" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea>
                            </td>
                        </tr>
                        <tr>
