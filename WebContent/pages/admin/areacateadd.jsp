...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">区域类别</a><span class="crumb-step">&gt;</span><span>新增类别</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/areacateaddoperate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <th width="120"><i class="require-red">*</i>区域名：</th>
                            <td>
                                <input class="common-text" name="areacate.area" size="50" value="" type="text">
                            </td>
                        </tr>
