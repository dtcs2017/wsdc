...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">商家管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="admin/getshoplist" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">商家名:</th>
                            <td><input class="common-text" placeholder="关键字" name="shop.shopname" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <!--<a href="admin/shopadd"><i class="icon-font"></i>添加商家</a>  -->
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <s:iterator value="pageBean.list">
                            ...
                            <td>
                            	<s:if test="state==1">
                            		已审核 
                            		<a class="link-update" href='admin/shopchangestate?shop.shopid=<s:property value="shopid"/>'>取消</a>
                            	 </s:if>
                            	<s:else>
                            		未审核
                            		 <a class="link-update" href='admin/shopchangestate?shop.shopid=<s:property value="shopid"/>'>审核</a>
                            	</s:else>
                            	
                            <td>
                                <a class="link-del" href='admin/shopdel?shop.shopid=<s:property value="shopid"/>'>删除</a>
                            </td>
                        </tr>
                        </s:iterator>
                    </table>
        ...
        <s:else>
            <a href="admin/getshoplist">首页</a>
            
            <a href='admin/getshoplist?pageBean.currentPage=<s:property value="pageBean.currentPage - 1"/>'>上一页</a>
        </s:else>
        
        <s:if test="pageBean.currentPage != pageBean.totalPage">
            <a href='admin/getshoplist?pageBean.currentPage=<s:property value="pageBean.currentPage + 1"/>'>下一页</a>
            
            <a href='admin/getshoplist?pageBean.currentPage=<s:property value="pageBean.totalPage"/>'>尾页</a>
        </s:if>
