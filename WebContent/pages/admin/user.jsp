    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="admin/getuserlist" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">用户名:</th>
                            <td><input class="common-text" placeholder="关键字" name="user.username" value="" id="" type="text"></td>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <s:iterator value="pageBean.list">
                            ...
                            <td>
                                ...
                                <a class="link-del" href='admin/userdel?user.userid=<s:property value="userid"/>'>删除</a>
                            </td>
                        </tr>
                        </s:iterator>
                    </table>
        ...
        <s:else>
            ...
            <a href='admin/getuserlist?pageBean.currentPage=<s:property value="pageBean.currentPage - 1"/>'>上一页</a>
        </s:else>
        
        <s:if test="pageBean.currentPage != pageBean.totalPage">
            <a href='admin/getuserlist?pageBean.currentPage=<s:property value="pageBean.currentPage + 1"/>'>下一页</a>
            
            <a href='admin/getuserlist?pageBean.currentPage=<s:property value="pageBean.totalPage"/>'>尾页</a>
        </s:if>
