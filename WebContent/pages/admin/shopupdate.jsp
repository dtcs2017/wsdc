    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/shopupdateoperate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="shop.shopid" value="<s:property value="shop.shopid"/>">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <input class="common-text" name="shop.address" size="50" value="<s:property value="shop.shopaddress"/>" type="text">
                            </td>
                        </tr>
                         <tr>
