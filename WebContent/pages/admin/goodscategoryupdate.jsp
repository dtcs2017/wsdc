...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">商品类别</a><span class="crumb-step">&gt;</span><span>类别管理</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/goodscategoryupdateoperate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                    <input type="hidden" name="goodscategory.goodscategoryid" value="<s:property value="goodscategory.goodscategoryid"/>">
                        <tbody><tr>
                            <th><i class="require-red">*</i>类别名：</th>
                            <td>
                                <input class="common-text" name="goodscategory.category" size="50" value="<s:property value="goodscategory.category"/>" type="text">
                            </td>
                        </tr>
