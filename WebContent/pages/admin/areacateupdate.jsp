...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">地理类别</a><span class="crumb-step">&gt;</span><span>区域修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/areacateupdateoperate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                    <input type="hidden" name="areacate.areacateid" value="<s:property value="areacate.areacateid"/>">
                        <tbody>
                        <tr>
                            <th width="120"><i class="require-red">*</i>上级区域：</th>
                            <td>
                                <select name="areacate.pid" id="catid" class="required">
                                    <option value="">请选择</option>
                                    <s:iterator value="areacateresult">
                                    <option value='<s:property value="areacateid"/>'><s:property value="area"/></option>
                                    </s:iterator>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>区域名：</th>
                            <td>
                                <input class="common-text" name="areacate.area" size="50" value="<s:property value="areacate.area"/>" type="text">
                            </td>
                        </tr>
